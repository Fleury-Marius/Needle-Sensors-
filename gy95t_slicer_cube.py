...
This script:
  ...
  3. Parses every field your Arduino sketch prints (acc_x/y/z, roll,
     pitch, yaw, temp, leve, mag_x/y/z).
  4. Rotates the cube live from roll/pitch/yaw.
  5. Overlays the raw accel + mag values as text in the 3D view's corner.
