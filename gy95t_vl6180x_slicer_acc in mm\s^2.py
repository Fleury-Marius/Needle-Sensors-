...
haven't already, then use the ArduinoConnect module to connect at 115200 baud
- that's the rate gy95t_vl6180x_combined.ino uses).
...
This script:
  ...
  4. Parses every field your combined Arduino sketch prints (acc_x/y/z in
     mm/s^2, roll, pitch, yaw, temp, leve, mag_x/y/z, distance_mm).
